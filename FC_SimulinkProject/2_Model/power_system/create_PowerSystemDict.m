function create_PowerSystemDict()
% 从 ParamSources/power_system_params.yaml 生成 PowerSystemDict.sldd
% 字典生成位置：本脚本所在目录 (2_Model/power_system/)
% 引用: GlobalTypes.sldd, VehicleDict.sldd

scriptDir = fileparts(mfilename('fullpath'));
dictName  = fullfile(scriptDir, 'PowerSystemDict.sldd');
yamlFile  = fullfile(scriptDir, '..', '..', '1_Data_Dictionaries', 'ParamSources', 'power_system_params.yaml');
