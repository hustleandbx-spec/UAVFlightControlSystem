function create_StateEstDict()
% 从 ParamSources/state_estimation_params.yaml 生成 StateEstDict.sldd
% 字典生成位置：本脚本所在目录 (2_Model/state_estimation/)
% 引用: GlobalTypes.sldd, VehicleDict.sldd

scriptDir = fileparts(mfilename('fullpath'));
dictName  = fullfile(scriptDir, 'StateEstDict.sldd');
yamlFile  = fullfile(scriptDir, '..', '..', '1_Data_Dictionaries', 'ParamSources', 'state_estimation_params.yaml');
